recall_target = [0.9, 0.928, 0.945, 0.970, 0.987, 0.992, 0.996, 0.997, 0.999]
...
csdann_sched_offload_cache_hit_rate = [0.62, 0.58, 0.55, 0.53, 0.48, 0.45, 0.42, 0.37, 0.32]
csdann_sched_offload_C = 3
csdann_sched_offload_B = 1.1
...
csdann_offload_cache_hit_rate = [0.62, 0.58, 0.55, 0.53, 0.48, 0.45, 0.42, 0.37, 0.32]
csdann_offload_C = 3
csdann_offload_B = 1.1
...
csdann_opt_storage_cache_hit_rate = [0.62, 0.58, 0.55, 0.53, 0.48, 0.45, 0.42, 0.37, 0.32]
csdann_opt_storage_C = 3
csdann_opt_storage_B = 1.1
...
hnsw_baseline_B = 1.3
csdann_reorder_B = 1.1

hnsw_baseline_cpu_cores = 6
csdann_reorder_cpu_cores = 6

hnsw_baseline_beam_width = 1
csdann_reorder_beam_width = 1

hnsw_baseline_cache_hit_rate = [0.46, 0.38, 0.36, 0.35, 0.33, 0.28, 0.25, 0.22, 0.17]
csdann_reorder_cache_hit_rate = [0.47, 0.43, 0.42, 0.39, 0.38, 0.35, 0.34, 0.33, 0.31]
